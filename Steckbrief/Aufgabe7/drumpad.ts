const Sound:HTMLAudioElement []= [new Audio('kick.wav'), new Audio('808.wav'), new Audio ('clap.wav'), new Audio('hihat.wav'), new Audio ('openhat.wav'), new Audio ('rim.wav'), new Audio ('chant.wav'), new Audio ('synth1.wav'),  new Audio ('synth2.wav')]
